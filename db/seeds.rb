...
RefDatum.create(nombre: 'Tipo Terapeuta', valor: 'Medicos Alternativos')
...
RefDatum.create(nombre: 'Dia preferente', valor: 'Miércoles')
RefDatum.create(nombre: 'Dia preferente', valor: 'Jueves')
RefDatum.create(nombre: 'Dia preferente', valor: 'Viernes')
RefDatum.create(nombre: 'Dia preferente', valor: 'Sábado')
